...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Snehapriyan, an independent developer specializing in custom software and AI automation.",
};
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              I am Snehapriyan, an independent developer specializing in building high-performance websites, custom software, and AI automation systems for ambitious businesses.
            </p>
          </div>
        </div>
      </section>
